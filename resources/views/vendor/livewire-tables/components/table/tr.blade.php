...
<tr
    ...
    {{
        $attributes->merge($customAttributes)
                ->class([
                    'bg-white dark:bg-gray-700 dark:text-white rappasoft-striped-row hover:brightness-95' => ($isTailwind && ($customAttributes['default'] ?? true) && $rowIndex % 2 === 0),
                    'bg-gray-50 dark:bg-gray-800 dark:text-white rappasoft-striped-row hover:brightness-95' => ($isTailwind && ($customAttributes['default'] ?? true) && $rowIndex % 2 !== 0),
