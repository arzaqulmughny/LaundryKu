...
$links = [
    ...
    [
        ...
        'svg' => '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path fill="currentColor" d="M4 19v2c0 .5523.44772 1 1 1h14c.5523 0 1-.4477 1-1v-2H4Z"/><path fill="currentColor" fill-rule="evenodd" d="M9 3c0-.55228.44772-1 1-1h8c.5523 0 1 .44772 1 1v3c0 .55228-.4477 1-1 1h-2v1h2c.5096 0 .9376.38314.9939.88957L19.8951 17H4.10498l.90116-8.11043C5.06241 8.38314 5.49047 8 6.00002 8H12V7h-2c-.55228 0-1-.44772-1-1V3Zm1.01 8H8.00002v2.01H10.01V11Zm.99 0h2.01v2.01H11V11Zm5.01 0H14v2.01h2.01V11Zm-8.00998 3H10.01v2.01H8.00002V14ZM13.01 14H11v2.01h2.01V14Zm.99 0h2.01v2.01H14V14ZM11 4h6v1h-6V4Z" clip-rule="evenodd"/></svg>',
        'title' => 'Transaksi',
    ],
    [
    ...
    [
        ...
        'title' => 'Laporan',
        'hide' => !role(['OWNER', 'ADMIN'])
    ],
    [
        'href' => route('settings.index'),
        'svg' => '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M9.586 2.586A2 2 0 0 1 11 2h2a2 2 0 0 1 2 2v.089l.473.196.063-.063a2.002 2.002 0 0 1 2.828 0l1.414 1.414a2 2 0 0 1 0 2.827l-.063.064.196.473H20a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-.089l-.196.473.063.063a2.002 2.002 0 0 1 0 2.828l-1.414 1.414a2 2 0 0 1-2.828 0l-.063-.063-.473.196V20a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2v-.089l-.473-.196-.063.063a2.002 2.002 0 0 1-2.828 0l-1.414-1.414a2 2 0 0 1 0-2.827l.063-.064L4.089 15H4a2 2 0 0 1-2-2v-2a2 2 0 0 1 2-2h.09l.195-.473-.063-.063a2 2 0 0 1 0-2.828l1.414-1.414a2 2 0 0 1 2.827 0l.064.063L9 4.089V4a2 2 0 0 1 .586-1.414ZM8 12a4 4 0 1 1 8 0 4 4 0 0 1-8 0Z" clip-rule="evenodd"/></svg>',
        'title' => 'Pengaturan',
        'hide' => !role(['OWNER'])
    ],
    [
        'href' => route('materials.index'),
        'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M3 10H21V20.0044C21 20.5543 20.5551 21 20.0066 21H3.9934C3.44476 21 3 20.5552 3 20.0044V10ZM9 12V14H15V12H9ZM2 3.99981C2 3.44763 2.45531 3 2.9918 3H21.0082C21.556 3 22 3.44372 22 3.99981V8H2V3.99981Z"></path></svg>',
        'title' => 'Persediaan',
        'submenu' => [
            [
                'href' => route('materials.index'),
...
<nav class="h-screen min-w-[300px] left-0">
    <div class="flex items-center p-5 py-5 md:py-8 gap-x-5">
        <div class="w-8">
            <img src="/{{ appIcon() }}" alt="" width="40" height="40">
        </div>

        <div class="flex flex-col gap-y-1">
            <h1 class="text-xs md:text-sm font-medium text-slate-700">{{ appName() }}</h1>
            <p class="text-xs whitespace-nowrap font-light text-slate-700">{{ appDesc() }}</p>
        </div>
    </div>

    <hr class="border-slate-300">

    <ul class="px-3 pt-3 flex flex-col gap-y-3">
        @foreach ($links as $link)
            @if (($link['hide'] ?? false) == false)
