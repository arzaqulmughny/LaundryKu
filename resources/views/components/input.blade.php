...
<div class="flex flex-col gap-y-1">
    ...
    <div class="relative flex items-center">
        <input type="{{ $type }}" autocomplete="off" id="{{ $name }}" name="{{ $name }}" class="w-full text-xs px-3 py-2 focus:outline-blue-400 text-slate-800 border-gray-300 border rounded-md" placeholder="{{ $placeholder }}" value="{{ $value }}" {{ $attributes }}>
